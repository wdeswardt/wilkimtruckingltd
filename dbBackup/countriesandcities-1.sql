...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2017 at 09:28 PM
...
--
-- Database: `countriesandcities`
--
CREATE DATABASE IF NOT EXISTS `countriesandcities` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
INSERT INTO `city` (`cityID`, `cityName`, `countryID`, `dateCreated`) VALUES
...
INSERT INTO `country` (`countryID`, `countryName`, `createDate`) VALUES
...
--
ALTER TABLE `city`
  MODIFY `cityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=601;
--
-- AUTO_INCREMENT for table `country`
--
ALTER TABLE `country`
  MODIFY `countryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
